...
func (r *ReconcileAdvancedCronJob) reconcileImageListPullJob(ctx context.Context, req ctrl.Request, advancedCronJob appsv1alpha1.AdvancedCronJob) (ctrl.Result, error) {
	...
	opts := &client.ListOptions{
		...
		FieldSelector: fields.SelectorFromSet(fields.Set{fieldindex.IndexNameForOwnerRefUID: string(advancedCronJob.UID)}),
	}
	if err := r.List(ctx, childJobs, opts, utilclient.DisableDeepCopy); err != nil {
